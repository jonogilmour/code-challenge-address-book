...
/**
 * Address book specific contact object.
 *
 * @typedef AddressBookContact
 * @memberof module:lib/contactsService
 * @property {String} name - Contact name.
 * @property {String} phoneNumber - Contact phone number.
...
class ContactsService {
     ...
     * @returns {module:lib/contactsService.AddressBookContact[]} Contact information for all contacts in all specified address books.
     */
    static async getContactsMultiple({ addressBookIds }) {
        ...
        ).where('address_book_id', 'in', addressBookIds);
